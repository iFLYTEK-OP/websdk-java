...
/**
 * @program: websdk-java
 * @description: 同声传译请求实体类
 * @author: zyding6
 * @create: 2025/3/23 22:43
 **/
public class SimultInterpretationRequest {
    ...
    public static class Parameter {
        ...
        public Parameter(SimultInterpretationClient client) {
        ...
        public static class Ist {
            ...
            public Ist(SimultInterpretationClient client) {
        ...
        public static class Streamtrans {
            ...
            public Streamtrans(SimultInterpretationClient client) {
        ...
        public static class Tts {
            ...
            public Tts(SimultInterpretationClient client) {
            ...
            public static class TtsResults {
                ...
                public TtsResults(SimultInterpretationClient client) {
