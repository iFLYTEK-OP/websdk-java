...
import cn.xfyun.service.lfasr.LfasrExecutorServiceV2;
 ...
 *
 */
public class LfasrClientV2 {

    private static final Logger logger = LoggerFactory.getLogger(LfasrClientV2.class);
     ...
     * 转写执行服务
     */
    private volatile LfasrExecutorServiceV2 lfasrExecutorServiceV2;
    ...
    /**
     * 通过Builder构建LfasrClientV2实例
     *
     * @param builder 构建器
     */
    public LfasrClientV2(LfasrClientV2.Builder builder) {
    ...
    public LfasrResponse uploadFile(String audioFilePath) throws LfasrException, SignatureException {
        ...
        // 执行文件任务
        return this.lfasrExecutorServiceV2.exec(new UploadFileTask(new LfasrSignature(appId, secretKey), param, audioFile));
    }
    ...
    public LfasrResponse getResult(String orderId, String resultType) throws SignatureException {
        return this.lfasrExecutorServiceV2.exec(new PullResultTaskV2(new LfasrSignature(appId, secretKey), orderId, resultType));
    }
    ...
    public static final class Builder {
        ...
        public LfasrClientV2.Builder coreThreads(Integer coreThreads) {
            this.coreThreads = coreThreads;
            return this;
        }

        public LfasrClientV2.Builder maxThreads(Integer maxThreads) {
            this.maxThreads = maxThreads;
            return this;
        }

        public LfasrClientV2.Builder maxConnections(Integer maxConnections) {
            this.maxConnections = maxConnections;
            return this;
        }

        public LfasrClientV2.Builder connTimeout(Integer connTimeout) {
            this.connTimeout = connTimeout;
            return this;
        }

        public LfasrClientV2.Builder soTimeout(Integer soTimeout) {
            this.soTimeout = soTimeout;
            return this;
        }

        public LfasrClientV2.Builder fileName(String fileName) {
            this.fileName = fileName;
            return this;
        }

        public LfasrClientV2.Builder fileSize(Long fileSize) {
            this.fileSize = fileSize;
            return this;
        }

        public LfasrClientV2.Builder duration(Long duration) {
            this.duration = duration;
            return this;
        }

        public LfasrClientV2.Builder language(String language) {
            this.language = language;
            return this;
        }

        public LfasrClientV2.Builder callbackUrl(String callbackUrl) {
            this.callbackUrl = callbackUrl;
            return this;
        }

        public LfasrClientV2.Builder hotWord(String hotWord) {
            this.hotWord = hotWord;
            return this;
        }

        public LfasrClientV2.Builder candidate(Short candidate) {
            this.candidate = candidate;
            return this;
        }

        public LfasrClientV2.Builder roleType(Short roleType) {
            this.roleType = roleType;
            return this;
        }

        public LfasrClientV2.Builder roleNum(Short roleNum) {
            this.roleNum = roleNum;
            return this;
        }

        public LfasrClientV2.Builder pd(String pd) {
            this.pd = pd;
            return this;
        }

        public LfasrClientV2.Builder audioMode(String audioMode) {
            this.audioMode = audioMode;
            return this;
        }

        public LfasrClientV2.Builder audioUrl(String audioUrl) {
            this.audioUrl = audioUrl;
            return this;
        }

        public LfasrClientV2.Builder standardWav(Integer standardWav) {
            this.standardWav = standardWav;
            return this;
        }

        public LfasrClientV2.Builder languageType(Integer languageType) {
            this.languageType = languageType;
            return this;
        }

        public LfasrClientV2.Builder trackMode(Short trackMode) {
            this.trackMode = trackMode;
            return this;
        }

        public LfasrClientV2.Builder transLanguage(String transLanguage) {
            this.transLanguage = transLanguage;
            return this;
        }

        public LfasrClientV2.Builder transMode(Short transMode) {
            this.transMode = transMode;
            return this;
        }

        public LfasrClientV2.Builder engSegMax(Integer engSegMax) {
            this.engSegMax = engSegMax;
            return this;
        }

        public LfasrClientV2.Builder engSegMin(Integer engSegMin) {
            this.engSegMin = engSegMin;
            return this;
        }

        public LfasrClientV2.Builder engSegWeight(Float engSegWeight) {
            this.engSegWeight = engSegWeight;
            return this;
        }

        public LfasrClientV2.Builder engSmoothproc(Boolean engSmoothproc) {
            this.engSmoothproc = engSmoothproc;
            return this;
        }

        public LfasrClientV2.Builder engColloqproc(Boolean engColloqproc) {
            this.engColloqproc = engColloqproc;
            return this;
        }

        public LfasrClientV2.Builder engVadMdn(Integer engVadMdn) {
            this.engVadMdn = engVadMdn;
            return this;
        }

        public LfasrClientV2.Builder engVadMargin(Integer engVadMargin) {
            this.engVadMargin = engVadMargin;
            return this;
        }

        public LfasrClientV2.Builder engRlang(Integer engRlang) {
            this.engRlang = engRlang;
            return this;
        }

        public LfasrClientV2 build() {
            LfasrClientV2 lfasrClientV2 = new LfasrClientV2(this);

            if (lfasrClientV2.lfasrExecutorServiceV2 != null) {
                logger.info("lfasrExecutorService is exist");
            }

            synchronized (LfasrClientV2.class) {
                if (lfasrClientV2.lfasrExecutorServiceV2 == null) {
                    lfasrClientV2.lfasrExecutorServiceV2 = LfasrExecutorServiceV2.build(coreThreads, maxThreads, maxConnections, connTimeout, soTimeout);
                }
            }
            return lfasrClientV2;
        }
    }
