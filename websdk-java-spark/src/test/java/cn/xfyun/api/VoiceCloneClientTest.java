...
public class VoiceCloneClientTest {
    ...
    public void defaultParamTest() {
        ...
        Assert.assertEquals(voiceCloneClient.getVcn(), "x5_clone");
    ...
    private void send(String text, VoiceCloneClient voiceCloneClient, String filePath) throws MalformedURLException, SignatureException, FileNotFoundException, UnsupportedEncodingException {
        // 存放音频的文件
